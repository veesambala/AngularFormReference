import { Logo } from '../../../../ugc-shared/factories/customization.factory';
...
describe('SubmissionPromptComponent', () => {
    ...
    /*
     Test that the components with values  set based on the ugc c11n
      */
    ...
    describe('Submission prompt component DOM ', () => {
        it('Media title is being rendered or not based on ugcC11nJSON', () => {
            let env: TestEnv = setup('IMAGE', 'TEST', 'Media', 'media');
            let title: HTMLElement = env.fixture.nativeElement.querySelector('.media-title');
