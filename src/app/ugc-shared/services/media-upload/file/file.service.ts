        ...
        this._http.post(this.mediaUrl(), this.mediaData)
            ...
            .subscribe((data: ApiUploadFileInfo) => {
                ...
                this.updateObserver({
                    ...
                    isError: true,
                    mediaFileId: this.id,
                    errorMessage: 'POST media/upload call failed even after ' + API_RETRY_ATTEMPTS_LIMIT + ' attempts.'
                });
            });
    }
        ...
        this._http.post(this.finalizeUrl(), payLoad, {
            ...
            .subscribe((data: ApiUploadFileInfo) => {
                ...
                this.updateObserver({
                    ...
                    isError: true,
                    mediaFileId: this.id,
                    errorMessage: 'POST media/{upload-id}/finalize call failed even after ' + API_RETRY_ATTEMPTS_LIMIT + ' attempts.'
                });
            });
