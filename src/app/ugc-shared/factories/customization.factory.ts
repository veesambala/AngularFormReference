...
export const BURST_LOGO: Logo = {
  ...
  clickThroughUrl: window.location.origin
};
...
export class CustomizationFactory {
  ...
  public static validateLocale(localeObject: any, objectName: string, enforce: boolean): string[] {
    ...
    Object.keys(locale.formField).forEach((key) => {
      let formFieldlocaleErrors: string[] = CustomizationFactory.validateLocaleFormField(locale.formField[key],
      objectName, enforce);
    ...
    BaseFactory.validateObjectField<string>(locale, objectName, 'addMediaNumberDisplay', '', enforce, validationErrors);
   ...
   */
  public static validateLocaleFormField(UgcLocaleFormFieldObject: any, objectName: string, enforce: boolean): string[] {
    let validationErrors: string[] = [];
    let UgcLocaleFromFieldObj: FormFieldsLocale = BaseFactory.validateObject<FormFieldsLocale>(
      UgcLocaleFormFieldObject, objectName, enforce, validationErrors);

    BaseFactory.validateObjectField<string>(UgcLocaleFromFieldObj, objectName, 'placeholder', '',
    enforce, validationErrors);
  ...
  public static validateTheme(themeObject: any, objectName: string, enforce: boolean): string[] {
    ...
    enforce, validationErrors);
    BaseFactory.validateObjectField<boolean>(theme, objectName, 'enableDesktopIconBackgrounds', false,
    enforce, validationErrors);
