...
export class MediaUploadService {
    ...
    /**
     * Creates a media upload object which does all the file upload handling.
     */
    public createMediaUpload() {
        if (this.mediaUpload && this.mediaUpload.isActive) {
            throw 'media upload instance already created. Call resetMediaItems() instead.';
        }
    ...
    /**
     * Clears all the media files added. Helpful when a new process of file upload begins from landing page.
     */
    public resetMediaItems() {
        if (!this.mediaUpload || !this.mediaUpload.isActive) {
            throw 'reset called on an invalid media-upload instance';
        }
     ...
     */
    public addMedia(files: FileList) {
...
export class MediaUploadInstance implements MediaUpload {
    ...
    /**
     * Returns all the failed media files
     */
    ...
    /**
     * Starts uploading a pending media.
